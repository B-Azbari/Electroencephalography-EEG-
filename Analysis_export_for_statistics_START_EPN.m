...
%save_suffix = 'Anova_EPN_Start_200-250';
%save_suffix = 'Anova_EPN_Start_250-300';
%save_suffix = 'Anova_EPN_Start_300-350';
%save_suffix = 'Anova_EPN_Start_350-400';
%save_suffix = 'Anova_EPN_Start_400-450';
%save_suffix = 'Anova_EPN_Start_450-500';
...
window_ms = [350 400];% time window peak detection N170 (in ms); !!!!!!!!!!!!!!!! EDIT ?
